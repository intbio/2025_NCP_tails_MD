### NCP<sub>20 mM</sub> - MD simulation trajectory of nucleosome core particle with full tails in solution with 20 mM NaCl (PDB ID 3LZ0)
...
<script>
  var pdb="trj/wt_20mm_NaCl_for_web.pdb"
  var xtc="trj/wt_20mm_NaCl_for_web.xtc"
  var csvfile="dat/wt_20mm_NaCl_dist_unwrap.csv"
  var trjstep = 10;
