### NCP<sub>100 mM</sub> - MD simulation trajectory of nucleosome core particle with full tails in solution with 100 mM NaCl (PDB ID 3LZ0)
...
<script>
  var pdb="trj/wt_100mm_NaCl_for_web.pdb"
  var xtc="trj/wt_100mm_NaCl_for_web.xtc"
  var csvfile="dat/wt_100mm_NaCl_dist_unwrap.csv"
  var trjstep = 10;
